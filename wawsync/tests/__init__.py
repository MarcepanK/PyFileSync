...
class TestWawSyncModule(unittest.TestCase):  # pylint: disable=R0904
    """ Module testsCase. """
    @staticmethod
    def __get_sources_file():
        """ Get all paths to source files in wawsync module. """
    ...
    def test_pylint(self):
        ...
        status = 0
        try:
            Run(['-d', 'I0011,R0801,R0902,R0903,R0921', 'wawsync'])
